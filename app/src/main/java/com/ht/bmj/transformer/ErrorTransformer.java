...
import com.ht.bmj.exception.ErrorType;
import com.ht.bmj.exception.ExceptionEngine;
import com.ht.bmj.exception.ServerException;
    ...
    public Observable<T> call(Observable<BaseHttpResult<T>> responseObservable) {
        ...
        return responseObservable.map(new Func1<BaseHttpResult<T>, T>() {
            ...
            public T call(BaseHttpResult<T> httpResult) {
                ...
                if (httpResult.getResult_code() != ErrorType.SUCCESS)
                    throw new ServerException(httpResult.getResult_code(), httpResult.getResult_message());
